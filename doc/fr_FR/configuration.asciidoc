...
Pour filtrer certaines lignes (LINE dans navitia) ou destination (définit par un couple origine-destination appelé ROUTE dans navitia), utiliser le paramètre 'forbidden_uris[]='.
Par exemple :
        forbidden_uris[]=line:RAT:M1 (ne pas afficher la ligne 1 du métro parisien)
        forbidden_uris[]=route:RAT:M1_R
...
SUBMIT
  -selectionner la ROUTE/LINE désirée, le code de type line:XXX:XXX sera indiqué
